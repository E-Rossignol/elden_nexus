...
class _WeaponDetailPageState extends State<WeaponDetailPage>
  ...
  Widget _statusEffect(bool exists) {
    ...
    List<Widget> hasNoStatus = [const Center(child: Text(""))];
    return SizedBox(
  ...
  Widget damageWidget() {
    ...
    return SizedBox(
      ...
      child: Table(
        columnWidths: const {0: FlexColumnWidth(1), 1: FlexColumnWidth(0.5)},
        children: [
          TableRow(
            children: [
              DecoratedBox(
  ...
  Widget build(BuildContext context) {
    ...
    String isSomberStr = weapon.isSomber
    ...
    return PopScope(
      ...
      onPopInvoked: (result) {
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                WeaponsPage(isDlc: widget.weapon.image.contains("dlc")),
          ),
        );
      },
      child: Scaffold(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color: weapon.requirements.str != 0
                                            ? Colors.redAccent
                                            : Theme.of(context)
                                                  .colorScheme
                            ...
                            DecoratedBox(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      requirement(weapon.requirements.dex),
                                      style: TextStyle(
                                        color: weapon.requirements.dex != 0
                                            ? Colors.redAccent
                                            : Theme.of(context)
                                                  .colorScheme
                                                  .onSecondaryContainer,
                            ...
                            DecoratedBox(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      requirement(weapon.requirements.int),
                                      style: TextStyle(
                                        color: weapon.requirements.int != 0
                                            ? Colors.redAccent
                                            : Theme.of(context)
                                                  .colorScheme
                                                  .onSecondaryContainer,
                            ...
                            DecoratedBox(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      requirement(weapon.requirements.fai),
                                      style: TextStyle(
                                        color: weapon.requirements.fai != 0
                                            ? Colors.redAccent
                                            : Theme.of(context)
                                                  .colorScheme
                                                  .onSecondaryContainer,
                            ...
                            DecoratedBox(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      requirement(weapon.requirements.arc),
                                      style: TextStyle(
                                        color: weapon.requirements.arc != 0
                                            ? Colors.redAccent
                                            : Theme.of(context)
                                                  .colorScheme
                                                  .onSecondaryContainer,
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: SingleChildScrollView(child: damageWidget()),
                        actions: [
                          Center(
                            child: ElevatedButton(
                              onPressed: () {
